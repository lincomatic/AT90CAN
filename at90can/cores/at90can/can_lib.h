...
{
  private:
    void Can_conf_bt(void);
    void can_clear_all_mob(void);
    unsigned char can_get_mob_free(void);
    unsigned char can_get_mob_status(void);
    void can_get_data(unsigned char* p_can_message_data);
    unsigned char can_auto_baudrate(unsigned char eval);
    unsigned char can_fixed_baudrate(unsigned char eval);
    
  public:
    unsigned short baudrate;
    void set_baudrate(unsigned short baud);
    unsigned char init(unsigned char mode);
    unsigned char cmd (st_cmd_t *);
    unsigned char get_status (st_cmd_t *); 
};
extern canlib CAN;
